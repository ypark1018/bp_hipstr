...
#allSTR - looks at all STR score difference in length of genotype from reference
#del - looks at deleterious regions score difference in length of genotype from reference
