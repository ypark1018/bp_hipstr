...
def main():
    if len(sys.argv) < 4:
        sys.exit("USAGE: python variant_score.py [input vep vcf] [rv .frq] [output prefix]")
        ...
        for n,indv in enumerate(locus[9:]):
            ...
            if "." in genotype:
                ...
                for a in genotype:
                    ...
                    #print genotype
                    #print rv[m]
                    if allele > 0 and rv[m - offset][allele] < 0.05:
                        all_allele = 1
                    else:
                        all_allele = 0
                    ...
                    #get rid of the 1st base because vep doesn't include
                        if alleles[allele][1:] in vep_alleles and rv[m - offset][allele] < 0.05:
